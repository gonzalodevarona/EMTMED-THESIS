...
@Mapper(uses = {SupplyMapper.class, LocationMapper.class, CountingUnitEntityMapper.class, MedicationBatchRequestEntityMapper.class, BatchRequestEntityMapper.class, MedicationBatchEntityMapper.class, BatchEntityMapper.class})
